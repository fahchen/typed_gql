defmodule Grephql.Generation.Schema do
  @moduledoc """
  ...
  Two node shapes share this struct:
    ...
    * union node — `kind: :union`, carries `union_module`,
      ...
      `Grephql.Types.Union` type module is created eagerly during resolve
  ...
  @doc """
  Walks the whole tree applying `fun` to every `Grephql.Generation.Field`.
